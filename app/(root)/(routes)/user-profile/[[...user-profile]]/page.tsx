    ...
    <div className="min-h-screen bg-main-gradient">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                <div className="w-24 h-24 rounded-full border-4 border-white dark:border-slate-700 shadow-lg bg-card flex items-center justify-center">
                  <span className="text-3xl font-bold text-card-foreground">{initials}</span>
                </div>
                <button
                  onClick={() => setIsEditing(true)}
                  className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-[#EECE84] hover:bg-[#e5c16e] text-black shadow-md flex items-center justify-center transition-transform hover:scale-110"
                  title="Edit profile"
                >
              ...
              <div>
                ...
                <p className="text-text-secondary mb-1">@{userData?.username || 'username'}</p>
          ...
          {/* Subscription Banner - Simple and integrated */}
          <div className="mt-6 bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 border border-yellow-200 dark:border-yellow-700/30 rounded-lg p-4 shadow-sm">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-yellow-400 dark:bg-yellow-500 flex items-center justify-center shadow-sm">
                  <span className="text-xl">☀️</span>
                </div>
                <div>
                  <p className="text-sm font-semibold text-yellow-900 dark:text-yellow-200">Subscription Plan</p>
                  <p className="text-base font-bold text-yellow-900 dark:text-yellow-100">Free Limited</p>
                </div>
              </div>
              <Button 
                onClick={() => router.push('/settings')}
                className="bg-yellow-500 hover:bg-yellow-600 dark:bg-yellow-600 dark:hover:bg-yellow-700 text-white font-medium px-5 py-2 shadow-sm"
              >

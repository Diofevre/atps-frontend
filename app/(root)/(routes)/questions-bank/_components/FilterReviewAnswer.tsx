...
import { Filter, Check, ChevronDown, CircleCheck, XCircle, HelpCircle, Flag } from 'lucide-react';

interface FilterAnswerProps {
  onFilterChange: (filter: string) => void;
}

const FilterAnswer: React.FC<FilterAnswerProps> = ({ onFilterChange }) => {
  ...
  const options = [
    ...
    { value: 'pinned', label: 'Flagged', icon: Flag }
  ];

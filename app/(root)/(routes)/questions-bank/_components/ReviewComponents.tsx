...
import FilterAnswer from './FilterReviewAnswer';
import NewTestModal from '../study/review/_components/Modal';
import QuestionDetailsDialog from '../study/review/_components/QuestionDetailsDialog';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        router.push('/questions-bank/study');
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 space-y-6">
        ...
        <div className="flex flex-row items-center gap-2">
          <FilterAnswer onFilterChange={setFilter} />
          <NewTestModal />
          <button
            onClick={() => {
              // Remove storage
        ...
        <div className="space-y-4">
          {filteredQuestions.map((question) => (
            ...
            >
              <Card
                key={question.questionId}
                className={`p-6 cursor-pointer border-white ${
